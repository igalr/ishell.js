...
export const localServer = (target: APIInterface): Promise<http.Server> => {
  ...
  app.get('/{*path}', (req, res) => { void serveMethod(req, res); });
  app.post('/{*path}', (req, res) => { void serveMethod(req, res); });
  app.put('/{*path}', (req, res) => { void serveMethod(req, res); });
  app.patch('/{*path}', (req, res) => { void serveMethod(req, res); });
  app.delete('/{*path}', (req, res) => { void serveMethod(req, res); });
